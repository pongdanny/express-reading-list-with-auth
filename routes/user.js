...
userRoutes.get("/user/register", csrfProtection, (req, res) => {
...
userRoutes.get("/user/login", csrfProtection, (req, res) => {
  ...
  check("confirmPassword")
    ...
    .custom((value, { req }) => {
      if (value !== req.body.password) {
        throw new Error("Conrifm Password does not match Password");
      }
      return true;
    }),
];
